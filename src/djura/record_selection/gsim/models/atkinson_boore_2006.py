...
class AtkinsonBoore2006(GMPE):
    ...
    def get_mean_and_stddevs(self, ctx: Context, imt: IMT):
        ...
        sig, tau, phi = np.zeros_like(mean), np.zeros_like(mean), np.zeros_like(mean)
        sig, tau, phi = set_sig(self.kind, None, sig, tau, phi)
...
class AtkinsonBoore2006MblgAB1987bar140NSHMP2008(AtkinsonBoore2006):
    ...
    """
    def __init__(self):
        super().__init__(mag_eq="Mblg87", scale_fac=0.)

class AtkinsonBoore2006MblgJ1996bar140NSHMP2008(AtkinsonBoore2006):
    """
    This class extends the original base class
    :class:`openquake.hazardlib.gsim.atkinson_boore_2006.AtkinsonBoore2006`
    """
    def __init__(self):
        super().__init__(mag_eq="Mblg96", scale_fac=0.)
        
class AtkinsonBoore2006Mwbar140NSHMP2008(AtkinsonBoore2006):
    """
    This class extends the original base class
    :class:`openquake.hazardlib.gsim.atkinson_boore_2006.AtkinsonBoore2006`
    """
    def __init__(self):
        super().__init__(mag_eq="Mw", scale_fac=0.)
...
class AtkinsonBoore2006MblgAB1987bar200NSHMP2008(AtkinsonBoore2006):
    ...
    """
    def __init__(self):
        super().__init__(mag_eq="Mblg87", scale_fac=0.5146)
        
        
class AtkinsonBoore2006MblgJ1996bar200NSHMP2008(AtkinsonBoore2006):
    """
    This class extends the original base class
    :class:`openquake.hazardlib.gsim.atkinson_boore_2006.AtkinsonBoore2006`
    """
    def __init__(self):
        super().__init__(mag_eq="Mblg96", scale_fac=0.5146)
        
        
class AtkinsonBoore2006Mwbar200NSHMP2008(AtkinsonBoore2006):
    """
    This class extends the original base class
    :class:`openquake.hazardlib.gsim.atkinson_boore_2006.AtkinsonBoore2006`
    """
    def __init__(self):
        super().__init__(mag_eq="Mw", scale_fac=0.5146)