...
class AbrahamsonGulerce2020SInter(GMPE):
    ...
    def get_mean_and_stddevs(self, ctx: Context, imt: IMT):
        ...
        C = self.COEFFS[imt]
        mean = get_mean_acceleration(C, trt, self.region, ctx, pga1000,
                                        self.apply_usa_adjustment)
        if self.sigma_mu_epsilon:
            # Apply an epistmic adjustment factor
            mean += (self.sigma_mu_epsilon * get_epistemic_adjustment(C, ctx.rrup))
...
class AbrahamsonGulerce2020SInterAlaska(AbrahamsonGulerce2020SInter):

    def __init__(self, ergodic=True, apply_usa_adjustment=False, sigma_mu_epsilon=0.0):
        super().__init__(
            region="USA-AK",
            ergodic=ergodic,
...
class AbrahamsonGulerce2020SSlabAlaska(AbrahamsonGulerce2020SSlab):
...
class AbrahamsonGulerce2020SInterCascadia(AbrahamsonGulerce2020SInter):
...
class AbrahamsonGulerce2020SSlabCascadia(AbrahamsonGulerce2020SSlab):
...
class AbrahamsonGulerce2020SInterCentralAmericaMexico(AbrahamsonGulerce2020SInter):
...
class AbrahamsonGulerce2020SSlabCentralAmericaMexico(AbrahamsonGulerce2020SSlab):
...
class AbrahamsonGulerce2020SInterJapan(AbrahamsonGulerce2020SInter):
...
class AbrahamsonGulerce2020SSlabJapan(AbrahamsonGulerce2020SSlab):
...
class AbrahamsonGulerce2020SInterNewZealand(AbrahamsonGulerce2020SInter):
...
class AbrahamsonGulerce2020SSlabNewZealand(AbrahamsonGulerce2020SSlab):
...
class AbrahamsonGulerce2020SInterSouthAmerica(AbrahamsonGulerce2020SInter):
...
class AbrahamsonGulerce2020SSlabSouthAmerica(AbrahamsonGulerce2020SSlab):
...
class AbrahamsonGulerce2020SInterTaiwan(AbrahamsonGulerce2020SInter):
...
class AbrahamsonGulerce2020SSlabTaiwan(AbrahamsonGulerce2020SSlab):
