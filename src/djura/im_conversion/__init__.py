...
"""
djura.im_conversion - conversion of fragility and vulnerability models
across intensity measures.
"""
from .._extras import require_extra

with require_extra("im_conversion"):
    from .ff import FF
...
def cite(style: str = "bibtex") -> str:
    """Return citation text for the im_conversion submodule."""
    if style != "bibtex":
        raise ValueError(
