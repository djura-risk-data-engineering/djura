...
the **djura** community a respectful and harassment-free experience for
...
- Harassment or intimidation of any participant, in public or private.
- Discriminatory or demeaning comments, or personal or political attacks.
...
repository, issue tracker, and pull requests — and also applies when an
...
maintainers at [info@djura.it](mailto:info@djura.it). All complaints will be
...
a private warning for a first or minor incident, a temporary restriction from
interaction for repeated or more serious incidents, and a permanent ban for
sustained or severe violations.
