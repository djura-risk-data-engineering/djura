...
Contributions and any derivative works thereof, **including the right to
relicense Your Contribution under any other license**, in particular for the
purpose of dual-licensing the Project under both AGPL-3.0 and a separate
commercial license.
...
4. You are not expected to provide support for Your Contributions, except to
...
to the terms of this Agreement. For non-trivial Contributions, the
Maintainer may additionally request that You add a `Signed-off-by:` line to
Your commit messages (per the Developer Certificate of Origin convention) or
record explicit consent in the pull request discussion.

---

This CLA is adapted from common templates including the Apache Individual
Contributor License Agreement v2.0 and the Harmony Agreements 1.0.
